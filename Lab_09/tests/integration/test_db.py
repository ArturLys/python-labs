...
from student_manager.db import (
    ConstraintViolationError, GroupRepository, NewStudent, RecordNotFoundError, StudentRecord, StudentRepository,
    StudentService, session_scope,
)
...
def test_import_many_is_atomic(service: StudentService) -> None:
    rows = [NewStudent("Ярина", "Бойко", "ФЕП-33", 90), NewStudent("Роман", "Скиба", "ФЕП-33", 85),
