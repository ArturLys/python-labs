...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--analytics", action="store_true", help="аналіз успішності (лабораторна робота №2)")
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.analytics:
        from student_manager.analytics.__main__ import main as analytics_main
