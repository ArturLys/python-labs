...
def assemble(
    lines: Iterable[str], minimum: float = 0.0, report: ValidationReport | None = None
) -> Generator[StudentRecord, None, None]:
...
def build_pipeline(
    path: Path, minimum: float = 0.0, report: ValidationReport | None = None
) -> Generator[StudentRecord, None, None]:
