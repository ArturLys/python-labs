...
from student_manager.api.dependencies import get_store, require_token
...
async def list_students(
    store: Store,
    last_name: Annotated[
        str | None, Query(min_length=1, description="Префікс прізвища, без урахування регістру")
    ] = None,
...
@router.delete(
    "/{student_id}", status_code=status.HTTP_204_NO_CONTENT, responses=NOT_FOUND, dependencies=[Depends(require_token)]
)
